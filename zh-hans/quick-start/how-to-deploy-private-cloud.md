...
![开通私有云服务](../assets/1-3.select\_private\_plan.png)
...
![获取私有云安装token](../assets/1-5.get\_install\_token.png)
...
![单机版安装步骤一](../assets/2-1.install\_single\_s1.png)
...
![单机版安装步骤二](../assets/2-2.install\_single\_s2.png)

安装完成的截图：

![单机版安装步骤三](../assets/2-3.install\_single\_s3.png)
...
![单机版安装步骤四](../assets/2-4.install\_single\_s4.png)

安装完成的截图：

![单机版安装步骤五](../assets/2-5.install\_single\_s5.png)
...
![集群权限步骤一](../assets/3-1-1.config\_cluster\_s1.png)
...
![集群权限步骤二](../assets/3-1-2.config\_cluster\_s2.png)

命令输出在172.16.0.78的执行结果：

![集群权限步骤三](../assets/3-1-3.config\_cluster\_s3.png)

命令输出在172.16.0.79的执行结果：

![集群权限步骤四](../assets/3-1-4.config\_cluster\_s4.png)

命令输出在172.16.0.80的执行结果：

![集群权限步骤五](../assets/3-1-5.config\_cluster\_s5.png)
...
![集群版安装步骤一](../assets/3-2-1.install\_cluster\_s1.png)
...
![集群版安装步骤二](../assets/3-2-2.install\_cluster\_s2.png)

安装完成的截图：

![集群版安装步骤三](../assets/3-2-3.install\_cluster\_s3.png)
...
![集群版安装步骤四](../assets/3-2-4.install\_cluster\_s4.png)

安装完成的截图：

![集群版安装步骤五](../assets/3-2-5.install\_cluster\_s5.png)
...
![安装进度点击“私有云”，通过节点信息的进度可以查看安装进度](../assets/4-1.install\_progress.png)

1. 安装完成后，打开美信拓扑控制台进入系统状态页面。

![如果所有检查项的状态都为正常，则表示服务已经正常](../assets/4-2.service\_status.png)
