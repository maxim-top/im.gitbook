...
*   消息搜索
    ...
    ```
#### 推送能力设置
蓝莺IM iOS版远程推送使用苹果APNs，需要在[开发者后台](https://developer.apple.com)的Identifiers页面进入您的App ID，在Capabilities页面开启Communication Notifications、Push Notifications和Time Sensitive Notifications。
