...
## 3.1 同意好友申请{#put\_\_roster\_accept}
...
## 3.2 申请加好友{#post\_\_roster\_apply}
...
| auth\_answer | string | false |     | 问题答案     |
| reason       | string | false |     | 申请描述     |
| user\_id     | int64  | true  |     | 被申请用户 ID |
...
## 3.3 批量添加好友{#post\_\_roster\_apply\_batch}
...
## 3.4 好友申请列表{#get\_\_roster\_apply\_list}
...
## 3.5 添加黑名单{#put\_\_roster\_block}
...
## 3.6 黑名单列表{#get\_\_roster\_blocked\_list}
...
## 3.7 拒绝好友申请{#put\_\_roster\_decline}
...
## 3.8 删除好友{#delete\_\_roster\_delete}
...
## 3.9 更新好友扩展信息{#put\_\_roster\_ext}
...
| mute\_notification | boolean | false |     | 是否消息免打扰: true - 消息免打扰, false - 不消息免打扰 |
| user\_id           | int64   | true  |     | 好友用户ID                                |
...
## 3.10 用ID搜索用户{#get\_\_roster\_id}
...
## 3.12 好友详情列表{#post\_\_roster\_list}
...
## 3.13 是否允许发消息{#get\_\_roster\_may\_message}
...
## 3.14 用手机号搜索用户{#get\_\_roster\_mobile}
...
## 3.15 用用户名搜索用户{#get\_\_roster\_name}
...
## 3.16 从黑名单移除{#delete\_\_roster\_unblock}
