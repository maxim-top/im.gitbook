...
description: >-
  在当今快速发展的技术环境中，企业需要不断提升工作效率以适应市场的变化。**通过AgentKit，企业可以快速部署多代理工作流，具体方法如下：1、使用Agent
  Builder设计工作流；2、利用Connector Registry管理数据连接；3、应用ChatKit嵌入定制化聊天体验。** 其中，采用Agent
  Builder来设计和迭代工作流是最关键的一步。Agent Builder提供了可视化
---
